  ...
  return (
    <section className="hero" id="hero">
      ...
      <div className="hero-content">
        ...
        <p className="hero-title animate-fade-in-up delay-2">
          <strong>{profile.title}</strong> — Building Production Systems
        </p>

        <p className="hero-summary animate-fade-in-up delay-3">
          {profile.summary}
        </p>
        ...
        <div className="hero-stats animate-fade-in-up delay-5">
          ...
          <div>
            ...
            <div className="hero-stat-label">Efficiency Gain</div>
          </div>
          <div>
            <div className="hero-stat-number">34</div>
